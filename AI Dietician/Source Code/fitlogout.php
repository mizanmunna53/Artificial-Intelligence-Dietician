...
<html>
  ...
  <div class="section">
      ...
      <div class="col s7 push-s5"><span class="flow-text"> 
          <img src="assets/images/fitexe1.png" width="100%" height="100%"> </span></div>
      <div class="col s5 pull-s7"><span class="flow-text"><h2> Exercise </h2>
          <p> <h4> Regular physical activity is just as important to a healthful lifestyle as smart eating. Get workout ideas, nutrition advice and tips for family exercise.</h4></p>
          </span></div>
    </div>
  </div>
  ...
  <div class="section">
       <div class="row">
      <div class="col s7 push-s5"><span class="flow-text"> <h2> Sports and Performance </h2>
          <p> <h4> Fuel your body the right way for optimal performance in sports and athletics. </h4></p>
          </span></div>
      <div class="col s5 pull-s7"><span class="flow-text"> 
          <img src="assets/images/fitsport.png" width="100%" height="100%"> 
          </span></div>
    </div>
  </div>
