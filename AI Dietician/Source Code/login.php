		...
		<form class="login-form" method="post" action="register.php">        
			<div class="row margin">
				<div class="input-field col s12">
					...
					<input id="user_name1" type="text" name="username1" class="validate">
					<label for="user_name1" class="center-align">Username</label>
				</div>
			</div>
			...
			<div class="row margin">
				<div class="input-field col s12">
					...
					<input id="user_passw1" type="password" name="password1" class="validate">
					<label for="user_passw1">Password</label>
				</div>
			</div>
			
			<div class="row">
				<div class="input-field col s12">
					<button type="submit" id="btn" name="login"> Login </button> <font color="black"> New User?  </font> <a href="register.php"> <font color="blue"> <u>  Register </u> </font> </a> 
				</div>
