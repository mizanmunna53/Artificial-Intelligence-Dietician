...
<html>
    ...
    <INPUT TYPE="reset"  VALUE="Reset" onClick="ClearForm(this.form)">
     ...
     <!-- Dropdown Trigger -->
        <a class='dropdown-trigger btn' href='#' data-target='dropdown2'> What's your bmi? </a>

  <!-- Dropdown Structure -->
  <ul id='dropdown2' class='dropdown-content'>
    <li><a href="40.php"> greater than 40</a></li>
    <li><a href="30.php"> 30 - 40 </a></li>
    <li><a href="22.php"> 22 - 30 </a></li>
    <li><a href="21.php"> 21 - 22 </a></li>
