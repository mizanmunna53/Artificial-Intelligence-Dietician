...
<html>
  ...
  <div class="section">
      ...
      <div class="col s7 push-s5"><span class="flow-text"> 
          <img src="assets/images/baby.png" width="100%" height="100%"> </span></div>
      <div class="col s5 pull-s7"><span class="flow-text"><h2> Healthy Baby </h2>
          <p> <h4> Food provides the energy and nutrients that babies need to be healthy. For a baby, breast milk is best. It has all the necessary vitamins and minerals. Infant formulas are available for babies whose mothers are not able or decide not to breastfeed.</h4></p>
          </span></div>
    </div>
  </div>
  ...
  <div class="section">
       <div class="row">
      <div class="col s7 push-s5"><span class="flow-text"> <h2> Care and Precautions </h2>
          <p> <h4> Infants usually start eating solid foods between 4 and 6 months of age. Check with your health care provider for the best time for your baby to start. If you introduce one new food at a time, you will be able to identify any foods that cause allergies in your baby. </h4></p>
          </span></div>
      <div class="col s5 pull-s7"><span class="flow-text"> 
          <img src="assets/images/baby2.png" width="100%" height="100%"> 
          </span></div>
    </div>
  </div>
