...
<html>
    ...
    <nav>
      <div class="nav-wrapper">
        <a href="#!" class="brand-logo"> Creating Healthier Lives...     <font color="black">Welcome Admin!</font> </a>
    ...
    <div class="nav-wrapper">
      ...
      <li><a href="todlogout.php"> Toddler </a></li>
        ...
        <div>
        <a href="http://localhost/phpmyadmin/sql.php?db=login&goto=db_structure.php&table=users&pos=0"> 
          <center> <h5>  Click here to see the users! </h5></center> 
            </a>
        </div>
