...
<html>
  ...
  <div class="section">
      ...
      <div class="col s7 push-s5"><span class="flow-text"> 
          <img src="assets/images/wom.png" width="100%" height="100%"> </span></div>
      <div class="col s5 pull-s7"><span class="flow-text"><h2> Eating Right </h2>
          <p> <h4> A balanced diet is a cornerstone of health. Women, like men, should enjoy a variety of foods, such as whole grains, fruits, vegetables, healthy fats, low-fat dairy and lean protein. But women also have special nutrient needs, and, during each stage of a woman's life, these needs change. </h4></p>
          </span></div>
    </div>
  </div>
  ...
  <div class="section">
       <div class="row">
      <div class="col s7 push-s5"><span class="flow-text"> <h2> Iron-rich Foods </h2>
          <p> <h4>Iron is one of the keys to good health and energy levels in women. Iron-rich food sources include red meat, chicken, turkey, pork, fish, kale, spinach, beans, lentils and fortified breads and cereals. Plant-based sources of iron are more easily absorbed by your body when eaten with vitamin C-rich foods. So eat fortified cereal with strawberries on top, spinach salad with mandarin orange slices or add tomatoes to lentil soup. </h4></p>
          </span></div>
      <div class="col s5 pull-s7"><span class="flow-text"> 
          <img src="assets/images/wom2.png" width="100%" height="100%"> 
          </span></div>
    </div>
  </div>
